...
public class ClienteService {
    ...
    public Cliente cadastrarCliente(RequestCliente requestCliente){
        ...
        BancoAula04Application.bancoCliente.adicionar(cliente);
        return cliente;
    }
    ...
    public Cliente detalhesCliente(UUID id) throws Exception {
        return BancoAula04Application.bancoCliente.detalheCliente(id);
    }
}
